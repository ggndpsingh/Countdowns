...
#if DEBUG
extension Countdown {
    static let preview: Countdown = .init(date: Date().addingTimeInterval(3600 * 3600).bySettingTimeToZero(), title: "This is a test title for", image: UIImage.randomSample)
}
#endif
